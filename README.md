...
`API_BASE_URL` is also supported. For Streamlit Cloud, this must be a public URL where the FastAPI backend is running. Do not use `http://127.0.0.1:8000` in deployed Streamlit secrets.
